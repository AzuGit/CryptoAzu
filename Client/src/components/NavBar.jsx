...
import logo from '../../images/CryptoAzu.png';


const NavbarItem = ({ title, classProps }) => {
  return (
    <li className={`mx-4 cursor-pointer hover:text-rose-500 ${classProps}`}>{title}</li>
  )
}
...
function NavBar() {
  ...
  return (
    <nav className="w-full flex md:justify-center justify-between items-center p-4">
      <div className="md:flex-[0.5] flex-initial hustify-center items-center">
      ...
      <ul className="text-white md:flex hidden list-none flex-row justify-between items-center flex-inital" >
        ...
        <li className="bg-[#2952e3] py-2 px-7 mex-4 rounded-full cursor-pointer hover:bg-[#2546bd]">
          Login
        </li>
      </ul>
